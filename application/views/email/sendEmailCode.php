                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p style="font-family: sans-serif;font-size: 14px;font-weight: bold;margin-top: 0;"><a href="<?php echo base_url(); ?>" style="text-decoration: none;color: #0078db;">AuctionOnClick.com</a></p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
