                    ...
                    <div class="desc_wrapper">
                        ...
                        <div class="shortlist_desc">
                            ...
                            <div class="desc_shortlist_button">
                                <button class="btn btn-default shortlist_list <?php echo ($auction_data[0]->is_fav)?'shortlist_list':''; ?>" type="button" onclick="addtoeventfavlist(<?php echo (int)$auction_data[0]->id; ?>)">
                            ...
                            <tbody>
								...
								<?php if($auction_data[0]->isSub > 0 || 1){ ?>
									...
									<tr>
										...
										<td> 
											<?php foreach($uploadedDocs as $key => $doc){ if($doc->status == 1){ ?>
												<a href="<?php echo $doc->file_path; ?>" download ><?php echo $doc->upload_document_field_name; ?></a><?php if($key+1 != count($uploadedDocs)){ ?>,<?php } ?>
											<?php } } ?>
											<br/>
											<?php foreach($uploadedDocs as $key => $doc){ if($doc->status == 0){ ?>
												<a href="<?php echo $doc->file_path; ?>" download ><?php echo $doc->upload_document_field_name; ?></a><?php if($key+1 != count($uploadedDocs)){ ?>,<?php } ?>
											<?php } } ?>
										</td>
									</tr>
