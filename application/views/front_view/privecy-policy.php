...
<!--                        <h3>Bank Auctions in Amritsar</h3>-->
           ...
           <div class="container-fluid">
               <div class="row ad_row_width">
                   <div class="col-sm-12">
                       <h3 class="premium_service">Privacy Policy</h3>
                   </div>
               </div>
           </div>
        <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="about_us_main faq_main privacy_policy">
                        <div class="privacy_policy_inner">
                                <h4>Privacy Policy of AuctionsOnClick.com</h4>
                                <p>At AuctionsOnClick we collect and manage user data according to the following Privacy Policy.</p>
                        </div>
                        <div class="privacy_policy_inner">
                        ...
                        <div class="privacy_policy_inner">
                            ...
                            <p>We only use your personal information to provide you the AuctionsOnClick services or to communicate with you about the Website or the services.</p>
