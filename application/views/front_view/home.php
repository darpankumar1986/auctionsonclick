...
<style>
    ...
    .dataTables_length {
        width: 283px; top:-32px; color:#000!important;   text-shadow:none!important;}
    ...
    .table_bg table {border: 1px solid #bbb;border-spacing: 0;border-top: 0;word-wrap: break-word;}
    .dataTables_wrapper .dataTables_filter input {width: 75% !important;padding: 10px 1%;}
    .dataTables_filter label{width: 364px;}
		...
		<section id="body_wrapper">
					 <div class="body_main">					
						<div style="clear:both"></div>
						 <?php /* ?><div class="box-heading" style="margin-bottom:10px;width:100%">
						   <marquee>EMD Fee is to be paid by NEFT / RTGS to the following account:- Bank Name: Axis Bank Ltd; Name of A/c: GORAKHPUR DEVELOPMENT AUTHORITY GORAKHPUR; A/c No: 914010003068671; Branch: Gorakhpur, UP; IFSC Code: UTIB0000331; Bank Address: Plot No. 560, Cross Road The Mall, Near Bank Road, Gorakhpur - 273001 </marquee>               
						</div><?php */ ?>
