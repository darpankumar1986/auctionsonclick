...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="/superadmin/uom_type/addedit" class="button_grey">Create UOM Type</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">UOM List</div>
				<?php /* ?>
			...
			<div class="container-outer">
				<div class="container-inner">
							<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
								...
								<thead>
									<tr>
										<th class="head0">UOM ID</th>
										<th class="head1">UOM Type Name</th>
								...
								<tbody>
									...
									$totalrows=$this->uom_type_model->GetTotalRecord($data->uom_id);
									
									?>
										<tr class='gradeA'>
											<td><?php echo $data->uom_id; ?> </td>
											<td><?php echo $data->uom_name; ?></td>
											...
											<td>
												<a href="/superadmin/uom_type/addedit/<?php echo $data->uom_id; ?>">Edit</a>
