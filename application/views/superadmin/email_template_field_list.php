...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="<?php echo base_url()?>superadmin/email_template/addedit" class="button_grey">Create Email Template</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Create Email Template</div>
				<?php /* ?>
				...
				<div class="container-inner">
							<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
								...
								<thead>
									<tr>
										...
										<th class="head1">Template Name</th>
                                                                                <th class="head0">Field Subject</th>
										<th class="head1">Field Message</th>
								...
								<tbody>
									...
									$totalrows=$this->email_template_model->GetTotalRecord($data->email_template_id);
									
									?>
										<tr class='gradeA'>
											<td><?php echo $data->email_template_id; ?> </td>
                                                                                        <td><?php echo $data->email_template_name; ?> </td>
											<td><?php echo $data->subject; ?></td>
											<td><?php echo $data->msg; ?></td>
											<td><?php echo ($data->status == 1)?'Active':'Inactive'; ?></td>
		
											<td>
												<a href="/superadmin/email_template/addedit/<?php echo $data->email_template_id; ?>">Edit</a>
