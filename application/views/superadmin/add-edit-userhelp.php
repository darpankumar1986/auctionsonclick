...
<section class="body_main1">	
		<div class="row">						
			<a href="/superadmin/user/indexhelp" class="button_grey">User List</a>
		</div>
		<div class="box-head">Create Helpdesk User</div>
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper box-content2">
				<div id="validation" class="subcontent">            	
					<form enctype="multipart/form-data" method="post" class="stdform" id="user" name="add_data_view" accept-charset="utf-8" action="/superadmin/user/savehelp" autocomplete="off">
						...
						<div class="row">
							...
							<div class="rgt_detail">
								...
								onchange="formAccording(jQuery(this).val())">
									...
									<?php /* ?>
									<option value="sales" <?php echo ($user_type=='sales')?'selected':''; ?>>Sales Admin</option>
						...
						<div id="forsalesuser1">
								<div class="row">
									<div class="lft_heading">C1 Zone <span class="red"> *</span></div>
									<div class="rgt_detail">
						...
						<div class="row">
							...
							<div class="rgt_detail">
                                                            <?php if($email_id!=''){$readonly='readonly=true';}else{$readonly='onblur="checkEmailExist(jQuery(this).val());"';} ?>
								<input maxlength="100" type="text" name="email_id" id="email_id" <?=$readonly;?>class="longinput html_found" value="<?php echo $email_id?>" />
