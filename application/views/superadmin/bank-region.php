...
<section class="container_12">		
		<div class="centercontent tables">
			<div class="pageheader notab">
				<div class="row">						
					<a href="/superadmin/bank_region/region_addedit" class=" button_grey">Create Region</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Bank Region List</div>
			</div><!--pageheader-->	
			...
			<form action="" method="GET" id="searchfm" name="searchfm">
				...
				<input type="hidden" name="controller" id="controller" value="bank_region" />
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
					...
					<thead>
						<tr>
							...
							<th class="head1" style='width: 20%;'>Region Name</th>
					...
					<tbody>
						<?php $i=0;foreach($records as $data){$i++;?>
							<tr class='gradeA'>
								...
								<td>
									<a href="/superadmin/bank_region/region_addedit/<?php echo $data->id; ?>">Edit</a> 
									<!--<br>
