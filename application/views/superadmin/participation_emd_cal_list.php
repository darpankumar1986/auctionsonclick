...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="<?php echo base_url()?>superadmin/participation_emd_cal/addedit" class="button_grey">Create Participation EMD Fee</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Participation EMD Fee List</div>
				<?php /* ?>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
								...
								<thead>
									<tr>
										...
										<th class="head1">Property Minimum Range Value</th>
										<th class="head1">Form Fee</th>
										<th class="head1">EMD Fee</th>
								...
								<tbody>
									...
									$totalrows=$this->participation_emd_cal_model->GetTotalRecord($data->participation_emd_id);
									
									?>
										<tr class='gradeA'>
											<td><?php echo $data->participation_emd_id; ?> </td>
											<td><?php echo $data->min_range; ?></td>
											<td><?php echo $data->participation_fee; ?></td>
											<td><?php echo $data->emd_fee; ?></td>
											...
											<td>
												<a href="/superadmin/participation_emd_cal/addedit/<?php echo $data->participation_emd_id; ?>">Edit</a>
											</td>
										</tr>
									<?php }?>	
