...
<section class="body_main1">
		<div class="row">		
			<a href="<?php echo base_url().'superadmin/news/banksliderlist/'.$bankId; ?>" class="button_grey"> Bank Header Slider (<?php echo $bankName; ?>)</a>
		</div>
		<div class="box-head">Add/Edit Homepage Slider Banner</div>
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper box-content2">
				<div id="validation" class="subcontent">
					<form enctype="multipart/form-data" method="post" class="stdform" id="bank" name="add_data_view" accept-charset="utf-8" action="/superadmin/news/addeditbankSliderSave/<?php echo $row->id?>">	
						...
						<div class="row">
							...
							<a href="<?php echo base_url().'superadmin/news/banksliderlist/'.$bankId; ?>" class="button_grey">Back</a>
