...
<script type="text/javascript" src="<?php echo VIEWBASE; ?>js/custom/forms.js"></script>
	...
	<section class="container_12">		
		<div class="row">						
			<a href="<?php echo base_url().'superadmin/user/bankeraddeditregion'?>" class="button_grey">Create Region User</a>
		</div>
					...
					<tbody>
						...
						?>
							...
							<tr class='gradeA'>
								...
								<td>
									<a href="<?php if($data->user_type=='b2c'){?>/superadmin/user/addedit_b2c/<?php echo $data->id; ?><?php }else{?>/superadmin/user/bankeraddeditregion/<?php echo $data->id; ?><?php }?>">Edit</a>
