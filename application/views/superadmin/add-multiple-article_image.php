...
<div class="centercontent">
	  <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="article_multiple_image" name="article_multiple_image" accept-charset="utf-8" action="/superadmin/article_image/save_multiple">	
				<p>
					<span class="field">
