			...
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb display">
			        <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <?php if($Change_status!='create_branch'&&$Change_status!=''){ ?>
                                          <?php /* ?>
                                           <td style="width:22%;  vertical-align:top; border-top: 1px solid #ddd;">
                                           ...
                                           <input type="text" value="<?php //=$auctionId;?>" name="auctionId" id="auctionId">-->
                                           </td>
                                       <td style="width:22%;  vertical-align:top; border-top: 1px solid #ddd;">
                                             <!--<label><strong>Event Id</strong></label>
                                             <input type="text" value="<?php //=$eventId;?>" name="eventId" id="eventId">-->
                                       </td>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
			...
			<thead>
			     <tr>
                                ...
                                <?php if($Change_status!='create_branch'){ ?>
			...
			<tbody id="Change_main_data">
			          ...
			          <tr class='gradeA'>
                                  ...
                                  <td><?php if($data->message!=''){ echo $data->message;  } ?>
                                  </td>
                                  <td>Submit</td>
                                  <td><?php echo $data->ip_address;?></td>
                                  <td><?php echo $data->indate; ?></td>
                                    <?php if($Change_status!='create_branch'){ ?>
                                  <!--<td><?php if($data->user_id){echo $data->user_id;}else{echo 'Not applicable';}?></td>-->
                                    <?php } ?>
