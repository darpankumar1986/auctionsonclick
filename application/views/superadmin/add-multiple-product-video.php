...
<div class="pageheader">
		...
		<ul class="hornav">
			...
			<li class="current"><a href="/superadmin/product_video/add_multiple_popup/<?php echo $product_id; ?>">Add Multiple Videos</a></li>
		</ul>
	</div>
...
<div class="centercontent">
	  <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="article_multiple_video" name="article_multiple_video" accept-charset="utf-8" action="/superadmin/product_video/save_multiple">	
				<p>
					<span class="field">
