...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="/superadmin/account_type/addedit" class="button_grey">Create Account Type</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Account Type List</div>
				<?php /* ?>
			...
			<div class="container-outer">
				<div class="container-inner">
							<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
								...
								<thead>
									<tr>
										<th class="head0">Account ID</th>
										<th class="head1">Account Type Name</th>
								...
								<tbody>
									...
									$totalrows=$this->account_type_model->GetTotalRecord($data->account_id);
									...
									?>
										<tr class='gradeA'>
											...
											<!--<td><input type="checkbox" class="status12" name="status[]" value="<?php echo $data->account_id; ?>"></td>-->
											<td>
												<a href="/superadmin/account_type/addedit/<?php echo $data->account_id; ?>">Edit</a>
