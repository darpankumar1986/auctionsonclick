...
<section class="container_12">
		...
		<?php } ?>		
		<div class="box-head">Blocked Buyer List</div>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb display">
				<tbody>
					<tr>
						...
						<td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;" colspan="6"><input type="text" class="custom_select no_top_mrgn" placeholder="Enter Email" name="title" value="<?php echo $search['title']?>"></td>
						<td style="width:22%;  vertical-align:top; border-top: 1px solid #ddd;"><select class="custom_select no_top_mrgn"  name="type" id="type" style="width:70%;">
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td>
							<a href="<?php if($data->user_type=='b2c'){?>/superadmin/user/addedit_b2c/<?php echo $data->id; ?><?php }else{?>/superadmin/user/bankeraddeditblock/<?php echo $data->id; ?><?php }?>"><strong>Edit</strong></a>
