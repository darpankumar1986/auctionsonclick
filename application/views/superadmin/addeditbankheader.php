...
<section class="body_main1">
		<div class="row">		
			<a href="<?php echo base_url().'superadmin/news/bankbannerlist/'.$bankId; ?>" class="button_grey"> Bank Header Banner (<?php echo $bankName; ?>)</a>
		</div>
		<div class="box-head">Add/Edit Homepage Header Banner</div>
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper box-content2">
				<div id="validation" class="subcontent">
					<form enctype="multipart/form-data" method="post" class="stdform" id="bank" name="add_data_view" accept-charset="utf-8" action="/superadmin/news/addeditbankheaderSave/<?php echo $row->id?>">	
						...
						<div class="row">
							<div class="lft_heading"> Upload Banner (650 x 90px) </div>
								<div class="rgt_detail">
						...
						<div class="row">
							...
							<a href="<?php echo base_url().'superadmin/news/bankbannerlist/'.$bankId; ?>" class="button_grey">Back</a>
