...
<section class="container_12">
		<div class="centercontent tables">
			<div class="pageheader notab">
				<div class="row">						
					<a href="/superadmin/rolepage/addeditpage" class=" button_grey">Create Page</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Page List</div>
									...
									<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
										...
										<tbody>
											<?php $i=0;foreach($records as $data){$i++;?>
												<tr class='gradeA'>
													<td><?php echo $data->role_page_id; ?></td>
													...
													<td>
														<a href="/superadmin/rolepage/addeditpage/<?php echo $data->role_page_id; ?>">Edit</a>
													</td>
												</tr>
											<?php }?>	
