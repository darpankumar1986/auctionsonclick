...
<div class="centercontent tables">
	<div class="pageheader notab">
		<h1 class="pagetitle"><span style="float:left"><?php echo $heading; ?></span><span style="float:right"><a href="/superadmin/attribute_group/addedit"  class="b_green"><strong>Add New</strong></a>	</span></h1>
	...
	<?php //Search start ?>
				...
				<tbody>
					<tr>
						...
						<td style="width:22%;  vertical-align:top; border-top: 1px solid #ddd;">
							&nbsp;
							<select name="product_id" id="product_id" style="width:70%;">
								<option value="">Choose One</option>
															<?php
							foreach($category as $group_record){?>
              <option value="<?php echo $group_record->id; ?>" <?php echo ($group_record->id==$search['product_id'])?'selected':''; ?>><?php echo $group_record->name; ?></option>
							<?php }?>
		...
		<input type="hidden" name="controller" id="controller" value="attribute_group" />
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td>
							<a href="/superadmin/attribute_group/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a> <br>
