...
<?php } ?>		
<div class="box-head">Bidder Final Submission Logs</div>
						...
						<tr>
						  <td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;" colspan="6">
						   ...
						   <td rowspan="3" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">
							   ...
							   <a href="<?php echo base_url()?>superadmin/user/bidderfinalsubmissionlog" class="button_grey">Reset</a>
						   </td>
						 </tr>
			        </tbody>
			</table>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td><?php echo $data->final_submit_ip; ?></td>
						<td><?php echo $data->final_submit_date; ?></td>
						<td><?php if($data->final_submit == 1){
									 echo "Final Submitted";}else{echo "Not Final Submitted";} ?></td>
						<td><?php echo $data->final_submit_message; ?></td>
