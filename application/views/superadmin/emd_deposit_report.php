...
<section class="container_12">
    ...
    if(isset($_POST['utr_no']) and !empty($_POST['utr_no']))
    {
        $utr_no=$_POST['utr_no'];
    }
    ?>
...
<?php } ?>		
<div class="box-head">EMD Deposit Details</div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb display">
					<tbody>
						...
						<tr>
							...
							<a href="<?php echo base_url()?>superadmin/user/emd_deposit_report" class="button_grey">Reset</a>
							</td>
						</tr>
					</tbody>
				</table>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">			
			<thead>
			     <tr>
						...
						<th class="head0">EMD Deposit Date</th>
						<th class="head0">Deposit Amount</th>
						<th class="head0">UTR No.</th>
						<th class="head0">Drawn on Bank</th>
			...
			<tbody>
				<?php 
					...
					<tr class='gradeA'>
						...
						<td><?php echo $email_id = GetTitleByField('tbl_user_registration',"id='".$row->bidderID."'",'email_id'); ?></td>
						<td><?php echo $emd_deposit_date;?></td>
						<td><?php echo $row->emd_amount;?></td>
						<td><?php echo $row->utr_no;?></td>
						<td><?php echo $row->drawn_bank;?></td>
						<td><?php echo $row->account_holder_bank_name; ?></td>
