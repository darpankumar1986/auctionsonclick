...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="/superadmin/location/addedit" class="button_grey">Create Location</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Location List</div>
	</div><!--pageheader-->	
							...
							<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
								...
								<thead>
									<tr>
										...
										<th class="head1">Location Name</th>
								...
								<tbody>
									...
									//$totalrows=$this->city_model->checkcityAttributeExist($data->location_id);
									...
									?>
										<tr class='gradeA'>
											...
											<td><?php echo GetTitleById('tbl_state',$data->stateID,'state_name'); ?></td>
											<td><?php echo ($data->status == 1)?'Active':'Inactive'; ?></td>
											<!--<td><input type="checkbox" class="status12" name="status[]" value="<?php echo $data->location_id; ?>"></td>-->
											<td>
												<a href="/superadmin/location/addedit/<?php echo $data->location_id; ?>">Edit</a>
											 
											 <!--
											 <?php if($totalrows<=0) { ?>
											 | 
											 <a href="javascript:;" data-id="<?php echo $data->location_id; ?>" class="deletelink"><strong>Delete</strong></a>
