...
<?php } ?>		
<div class="box-head">User Registration / Profile Update Logs</div>
				...
				<tbody>
					<tr>
						...
						<td rowspan="3" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">
							...
							<a href="<?php echo base_url()?>superadmin/user/bidderegisterlog" class="button_grey">Reset</a>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<tbody id="Change_main_data">
				<?php 
			          ...
			          <tr class='gradeA'>
								  ...
								  <td><?php echo ($data->remark != '') ? $data->remark:'--'; ?></td>
                                </tr>
				<?php }?>	
			  </tbody>
		    </table>
