...
<div class="centercontent tables" style="margin-left:0px;">
	<div class="pageheader">
		...
		<ul class="hornav">
			<li class="current"><a href="/superadmin/product_video/page_popup/<?php echo $product_id; ?>">View Videos</a></li>
			<li ><a href="/superadmin/product_video/add_popup/<?php echo $product_id; ?>">Add Video</a></li>
				...
				<tbody>
					...
					<?php
						...
						<tr class='gradeA'>
							...
							<td>
								<a href="/superadmin/product_video/edit_popup/<?php echo $data->id; ?>"><strong>Edit</strong></a>
...
function updatestatus(type,imgID,stval){
	 jQuery.ajax({
              url:  "<?php echo base_url();?>superadmin/product_video/updateimageVideoStatus",
              type: "post",
...
function deleteImage(type,imgID,stval){
	if(confirm('Are you sure want to delete this record?')){
	 jQuery.ajax({
              url:  "<?php echo base_url();?>superadmin/product_video/DeleteimageVideoStatus",
              type: "post",
              data: "type="+type+"&id="+imgID+"&stval="+stval,
              success: function(results){
				  alert(results);
