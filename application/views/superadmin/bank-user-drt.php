...
<script type="text/javascript" src="<?php echo VIEWBASE; ?>js/custom/forms.js"></script>
	...
	<section class="container_12">		
		<div class="row">						
			<a href="<?php echo base_url().'superadmin/user/bankeraddeditdrt'?>" class="button_grey">Create DRT User</a>
		</div>
		...
		<?php } ?>
		<div class="box-head">DRT User List</div>
					...
					<tbody>
						<?php $i=0;foreach($records as $data){$i++;?>
							<tr class='gradeA'>
								...
								<td>
									<a href="<?php if($data->user_type=='b2c'){?>/superadmin/user/addedit_b2c/<?php echo $data->id; ?><?php }else{?>/superadmin/user/bankeraddeditdrt/<?php echo $data->id; ?><?php }?>">Edit</a>
