...
<div class="box-head">Bidder Listing</div>
			...
			<tbody id="Change_main_data">
				<?php 
			          ...
			          <tr class='gradeA'>
                                  ...
                                  <td><a href="<?php echo base_url()?>/superadmin/user/change_status/<?php echo $data->id;?>" style="color:blue;" onclick="return confirm('Are you sure?')"><?php echo ($data->status==0)?'Active':'Inactive';?></a></td>
