		...
		<div class="pageheader">
			<?php if(isset($this->session->userdata['flash:old:message'])){?>							
						<div class="success_msg"> 
							<?php 
								echo $message =  @$this->session->userdata['flash:old:message']; 																	
							?>
						</div>
					<?php } ?>
		</div><!--pageheader-->
		<div class="box-head">Robots</div>
		<div class="centercontent">
			
			<div id="contentwrapper" class="contentwrapper box-content2">
				<div id="validation" class="subcontent">
					<form enctype="multipart/form-data" method="post" class="stdform" id="bank" name="add_data_view" accept-charset="utf-8" action="">	

						
						<div class="row">
							<div class="lft_heading"> Robots File </div>
								<div class="rgt_detail">
								<input onchange="validate_upload('image');" type="file" name="robots" id="robots">&nbsp;(Format Allow: txt)
								<br/><a target="_blank" href="robots.txt">View</a>
							</div>
						</div>
						
                        <div class="stdformbutton row" style="text-align:center;">
							<a href="<?php echo base_url().'superadmin/home'?>" class="button_grey">Back</a>
							<input type="submit" name="submit" value="Submit" class="button_grey">							
						</div>
