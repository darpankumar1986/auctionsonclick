...
<section class="body_main1">
		<div class="row">						
			<a href="<?php echo base_url().'superadmin/user/bankerzone'?>" class="button_grey">Zone User List</a>
		</div>
		<div class="box-head">Create Zone User</div>
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper box-content2">
				<div id="validation" class="subcontent">            	
					<form enctype="multipart/form-data" method="post" class="stdform" id="user" name="add_data_view" accept-charset="utf-8" action="/superadmin/user/saveBankuserzone">
						<div class="row">
						...
						<div class="row">
							...
							<div class="rgt_detail">
								...
								<input maxlength="100" type="text" name="email_id" id="email_id" class="longinput" value="<?php echo $email_id?>"/>
						...
						<div class="row" id="userid">
							<div class="lft_heading">User ID <span class="red"> *</span> </div>
							<div class="rgt_detail">
								<input  maxlength="100" type="text" name="user_id" id="user_id" placeholder="" class="longinput alphanumeric1" value="<?php echo $user_id?>" onblur="checkUserIdExist(jQuery(this).val());"/>
						...
						<div class="row">
							...
							<div class="rgt_detail">
								<input type="password" name="cpassword" id="cpassword" class="longinput" value="" class="longinput password"/>
							</div>
						</div>
						<?php } ?>
						<div class="row">
						...
						<div class="row">
							...
							<div class="rgt_detail">
								<input type="text" maxlength="50" name="designation" id="designation" class="longinput" value="<?php echo $designation?>" />
							</div>					
						</div>
						<div class="row">
							<div class="lft_heading">Mobile Number/Phone No. <span class="red"> *</span></div>
							<div class="rgt_detail">
								<input maxlength="15" type="text" name="mobile_no" id="mobile_no" maxlength="10" onkeypress="return isNumberKey(event);" class="longinput" value="<?php echo $mobile_no?>" />
							</div>					
						</div>
						<div class="row">
