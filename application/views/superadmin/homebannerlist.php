...
<div class="centercontent tables">
	<div class="pageheader notab">
		<?php
		 ...
		 if($records == 0) { ?>
		<div class="row">						
			<a href="/superadmin/news/addedithomeheader" class=" button_grey">Create Homepage Header Banner</a>
		</div>
		<?php } ?>
		...
		<?php } ?>
		<div class="box-head">Homepage Header Banner</div>
	</div><!--pageheader-->	
					...
					<tbody>
						<?php $i=0;foreach($records as $data){$i++;?>
							<tr class='gradeA'>
								...
								<td>
										<a href="/superadmin/news/addedithomeheader/<?php echo $data->id; ?>">Edit</a> 
									<!--<br>
