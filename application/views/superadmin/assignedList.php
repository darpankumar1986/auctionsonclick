...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?>superadmin/viewer/getAuctionListAssigned',
						//"bJQueryUI": true,
                ...
                <div class="table-wrapper btmrg20 tpmrg20">
                           ...
                           <div style="min-height: 0px; display: block;" class="box-content no-pad table-tp-space"> 
                            <?php 
									...
									$this->table->set_heading('ID', 'Auction ID','Email','Organization Name',  'Event Start Date', 'Event End Date','Action');	
