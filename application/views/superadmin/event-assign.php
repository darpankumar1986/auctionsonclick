...
<section class="container_12">
    ...
    <?php } ?>		
    <div class="box-head">Event Assign/Reassign List</div>
                                ...
                                <thead>
                                    <tr>
                                       ...
                                       <!--<th class="head1">Activity Name</th>-->
                                        ...
                                        <th class="head1">Event Assigned From</th>
                                ...
                                <tbody id="Change_main_data">
                                    ...
                                    foreach ($records as $data) {
                                        ...
                                        <tr class='gradeA'>
                                            ...
                                            <td><?php echo $data->from_first_name . " " . $data->from_last_name; ?></td>
                                            <td><?php echo $data->to_first_name . " " . $data->to_last_name; ?></td>
