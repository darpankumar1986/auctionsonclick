...
<?php } ?>		
<div class="box-head">Bid Submission Logs</div>
						...
						<tr>
						  <td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;" colspan="6">
						   ...
						   <td rowspan="3" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">
							   ...
							   <a href="<?php echo base_url()?>superadmin/user/bidsubmitlog" class="button_grey">Reset</a>
						   </td>
						 </tr>
			        </tbody>
			</table>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
			...
			<thead>
			     <tr>
                                ...
                                <th class="head0">Bid Value</th>
                                <?php /* ?><th class="head1">Browser Type</th><?php */ ?>
                                <th class="head0">Email ID</th>
                                <!--<th class="head0">Bid Type</th>-->
                                <th class="head1">Indate</th>
                                <th class="head1">In Milisecond</th>
