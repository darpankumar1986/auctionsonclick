...
<div class="centercontent tables" style="margin-left:0px;">
	<div class="pageheader">
		...
		<ul class="hornav">
			<li class="current"><a href="/superadmin/article_quote/page_popup/<?php echo $article_id; ?>">View Quotes</a></li>
			<li class=""><a href="/superadmin/article_quote/add_popup/<?php echo $article_id; ?>">Add Quote</a></li>
		</ul>
	</div>	
	...
	<div id="contentwrapper" class="contentwrapper">
		<div class="subcontent">
			<input type="hidden" name="controller" id="controller" value="article_quote" />
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
				...
				<thead>
					<tr>
						<th class="head0" style='width: 10%;'>ID</th>
						<th class="head1" style='width: 30%;'>Title</th>
						<th class="head0" style='width: 10%;'>Priority</th>
						<th class="head0" style='width: 15%;'>Status</th>
				...
				<tbody>
					...
					foreach($records as $data){$i++;?>
						<tr class='gradeA'>
							...
							<td>
								<a href="/superadmin/article_quote/edit_popup/<?php echo $data->id; ?>"><strong>Edit</strong></a>
