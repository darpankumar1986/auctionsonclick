...
<?php } ?>		
<div class="box-head">Final Approver Logs</div>
						...
						<tr>
						  <td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;" colspan="6">
						   ...
						   <td rowspan="3" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">
							   ...
							   <a href="<?php echo base_url()?>superadmin/user/finalapproverLog" class="button_grey">Reset</a>
						   </td>
						 </tr>
			        </tbody>
			</table>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td><?php echo $data->opener2_accepted_ip; ?></td>
						<td><?php echo $data->opener2_accepted_date; ?></td>
						<td><?php if($data->operner2_accepted == 1){
									 echo "Accepted";}else{echo "Rejected";} ?></td>
						<td><?php echo $data->operner2_comment; ?></td>
