  ...
  ?>
		<section class="header_wrapper">
						<div class="header_top">
								<div class="logo"><a href="<?php echo base_url().'superadmin/home'?>"><img src="<?php echo VIEWBASE; ?>images/logo.png" width="192" height="60" alt="Bank eauctions"></a></div>
	...
	<div class="container_12">
		...
		<span class="flt_rgt">
			...
			<select name="ddlLogin" id="ddlLogin" title="Select Link"  onchange="location = this.options[this.selectedIndex].value;">
						...
						<option value="<?=  base_url();?>superadmin/event_log/index">Log Event</option>
						<option value="<?=  base_url();?>superadmin/event_log/assign_event_report">Assign/Reassign Event</option>
						<option value="<?=  base_url();?>superadmin/event_log/select_bankuser">Select BankUser</option>
						<option value="<?=  base_url();?>superadmin/event_log/upload_docimg">Upload Document/ Images</option>
						<option value="<?=  base_url();?>superadmin/event_log/doc_to_be_submit">Document to be submitted</option>
						<option value="<?=  base_url();?>superadmin/event_log/second_opener">Second OpenerPublish Tender</option>
			</select>
			<?php */ ?>
		</span>
...
<div class="bodywrapper">
                ...
                <div class="userdata">
                   ...
                   <!-- <span class="email">youremail@yourdomain.com</span>-->
                    <ul>
                        ...
                        <li><a href="<?php echo base_url().'superadmin/logout'?>">Sign Out</a></li>
                    </ul>
                </div><!--userdata-->
            </div><!--userinfodrop-->
        </div><!--right-->
    ...
    <div class="header">
    	<ul class="headermenu">
        	<li <?php if($this->uri->segment(2)!='report'){?>class="current"<?php }?>><a href="<?php echo base_url()?>superadmin/home"><span class="icon icon-flatscreen"></span>Dashboard</a></li>
            <!--<li><a href="#"><span class="icon icon-pencil"></span>Manage Blog</a></li>
            <li><a href="#"><span class="icon icon-message"></span>Messages</a></li>-->
            <!--<li <?php if($this->uri->segment(2)=='report'){?>class="current"<?php }?>><a href="<?php echo base_url()?>superadmin/report"><span class="icon icon-chart"></span>Reports</a></li>-->
        </ul>
    </div><!--header--> 
<?php */ ?>
