...
<div class="centercontent tables">
	<div class="pageheader notab">
		<?php
		 if($records == 0) { ?>
		<div class="row">						
			<a href="/superadmin/news/addedit" class=" button_grey">Create Homepage Breaking News</a>
		</div>
		<?php } ?>
		...
		<?php } ?>
		<div class="box-head">Homepage Breaking News</div>
	</div><!--pageheader-->	
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="">
					...
					<thead>
						<tr>
							...
							<th class="head1" style='width: 20%;'>Event Title</th>
						...
						<?php $i=0;foreach($records as $data){$i++;?>
							<tr class='gradeA'>
								...
								<td>
									...
									if($type=='blog'){
									?>		
										<a href="/superadmin/news/blogaddedit/<?php echo $data->id; ?>">Edit</a> 
									<?php }else{?>	
										<a href="/superadmin/news/addedit/<?php echo $data->id; ?>">Edit</a> 
									<?php } ?>
									<!--<br>
