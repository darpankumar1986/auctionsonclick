...
<section class="container_12">
	<div class="row">						
			<a href="/superadmin/user/addedit" class="button_grey">Create Sales Coordinator/Executive User</a>
		</div>
		<div class="box-head">Sales User List</div>
	<div class="centercontent tables">
		<div class="pageheader notab">
			<?php /* ?>
			<h1 class="pagetitle"><span style="float:left"><?php echo $heading; ?></span><span style="float:right"><a href="/superadmin/user/addedit" class="b_green"><strong>Add New</strong></a>	</span></h1>
			<?php */ ?>
				...
				<tbody>
					<?php $i=0;foreach($records as $data){$i++;?>
						<tr class='gradeA'>
							...
							<td><?php echo $data->c1_zone_name; ?></td>
							...
							<td>
								<a href="<?php if($data->user_type=='b2c'){?>/superadmin/user/addedit_b2c/<?php echo $data->id; ?><?php }else{?>/superadmin/user/addedituser/<?php echo $data->id; ?><?php }?>">Edit</a>
