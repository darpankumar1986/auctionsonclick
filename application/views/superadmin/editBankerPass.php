...
<section class="body_main1">	
		<div class="row">		
					...
					<a href="<?php echo base_url().'superadmin/pass/cBank'?>" class="button_grey"> Banker List</a>
		</div>
		...
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper box-content2">
				<div id="validation" class="subcontent">            	
					<form enctype="multipart/form-data" method="post" class="stdform" id="category" name="add_data_view" accept-charset="utf-8" action="/superadmin/pass/saveBanker/<?php if($id) echo $id;?>">	
						...
						<div class="row">
							<div class="lft_heading">User ID</div>
							<div class="rgt_detail">
								<?php echo $userid; ?>
							</div>				
						</div>
