...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="/superadmin/master_bank/addedit" class="button_grey">Create Bank</a>
				</div>
				...
				<div class="container-inner">
							<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
								...
								<tbody>
									...
									$totalrows=$this->master_bank_model->GetTotalRecord($data->bank_id);
									...
									?>
										<tr class='gradeA'>
											...
											<!--<td><input type="checkbox" class="status12" name="status[]" value="<?php echo $data->bank_id; ?>"></td>-->
											<td>
												<a href="/superadmin/master_bank/addedit/<?php echo $data->bank_id; ?>">Edit</a>
