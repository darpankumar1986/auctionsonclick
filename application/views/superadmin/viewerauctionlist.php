...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?>superadmin/viewer/getAuctionList',
						//"bJQueryUI": true,
                ...
                <div class="table-wrapper btmrg20 tpmrg20">
                           ...
                           <div style="min-height: 0px; display: block;" class="box-content no-pad table-tp-space"> 
                            <?php 
									...
									$this->table->set_heading('Event ID', 'Organization Name',  'Event Start Date', 'Event End Date', 'Status','Action');	
