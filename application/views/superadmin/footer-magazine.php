...
<div class="centercontent tables">
	...
	<div id="contentwrapper" class="contentwrapper">
		<input type="hidden" name="controller" id="controller" value="footer_magazine" />
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td><?php echo $data->footer_magazine_name; ?></td>
						<td><?php echo $data->footer_magazine_url; ?></td>
						...
						<td><?php echo GetDateFormat($data->addedDate); ?></td>
						<td>
							<a href="/superadmin/footer_magazine/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
