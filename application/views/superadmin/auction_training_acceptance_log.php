...
<?php } ?>		
<div class="box-head">Auction Training Acceptance Log</div>
						...
						<tr>
						  <td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;" colspan="6">
						   ...
						   <td rowspan="3" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">
							   ...
							   <a href="<?php echo base_url()?>superadmin/user/auctiontraininglog" class="button_grey">Reset</a>
						   </td>
						 </tr>
			        </tbody>
			</table>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td><?php echo $data->is_accept_auct_training_ip; ?></td>
						<td><?php echo $data->is_accept_auct_training_date; ?></td>
						<td>
							<?php if($data->is_accept_auct_training == 1){ echo "Accepted";}else{echo "Not Accepted";} ?>
						</td>
						<td><?php echo $data->is_accept_auct_training_message; ?></td>
