...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?>superadmin/rbidder/getBidderList/<?php echo $auctionId; ?>',
						//"bJQueryUI": true,
				...
				,"fnRowCallback": function (nRow, aData, iDisplayIndex) {
							...
							{ 
								...
								var imgTag = '<a href="<?php echo base_url(); ?>superadmin/rbidder/rbidderAuction/'+aData[0]+'/'+aData[2]+'/'+aData[3]+'">Remove from auction</a>';
							 }
							 else
							 {
								var imgTag ='';
                ...
                <div class="table-wrapper btmrg20 tpmrg20">
                          ...
                          <div style="min-height: 0px; display: block;" class="box-content no-pad table-tp-space"> 
                            <?php 
									...
									$this->table->set_heading('P ID', 'Email','Auction ID','Bidder ID','Added Type',  'Final submit','Action');	
									echo $this->table->generate(); 
								?> 	
                          </div>
                          </div>
                          <br/>
                          <a href="<?php echo base_url()?>superadmin/rbidder/">Back</a>
          </div>
            </div>
      </div>
        </div>
