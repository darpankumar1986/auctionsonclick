			 ...
			 <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb">
				<tbody>
					<tr>
						...
						<td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;" colspan="6"><input type="text" placeholder="Enter title Name" name="title" value="<?php echo $search['title']?>"></td>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<thead>
				<tr>
					...
					<th width="18%" class="head1">Property title</th>
					<th width="5%" class="head0">Status</th>
					<th width="5%" class="head1"><input type="checkbox" id="selecctall1"/> Select</th>
					<th width="8%" class="head1">Added Date</th>
					<th width="8%" class="head1">Update Date</th>
					<th width="15%" class="head1">Actions</th>
				</tr>
			</thead>
				...
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<a target="_blank" href="/property/admindetail/<?php echo $data->id; ?>"><strong>View</strong></a>|| 
						 <select style="width:100px;" onchange="actionOnProduct(this.value,<?php echo $data->id;?>);">
...
function actionOnProduct(status,pid){
		 jQuery.ajax({
				  url:  "<?php echo base_url();?>superadmin/non_banker/productaction",
				  type: "post",
