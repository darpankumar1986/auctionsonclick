...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="breaking_news" name="add_data_view" accept-charset="utf-8" action="/superadmin/insight/save">	
				...
				<p>
					...
					<span class="field">
						<input type="text" name="author" id="author" class="longinput" value="<?php echo $author?>" />
					</span>					
				</p>
				<p>
					<label>Description</label>
					<span class="field"><textarea name="description" id="description" ><?php echo $description?></textarea></span>
				</p>
