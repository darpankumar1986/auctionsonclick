...
<?php } ?>		
<div class="box-head">Bidder Participitated Agreement Log</div>
						...
						<tr>
						  <td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;" colspan="6">
						   ...
						   <td rowspan="3" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">
							   ...
							   <a href="<?php echo base_url()?>superadmin/user/iagreelog" class="button_grey">Reset</a>
						   </td>
						 </tr>
			        </tbody>
			</table>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td><?php echo $data->is_accept_tc_ip; ?></td>
						<td><?php echo $data->is_accept_tc_date; ?></td>
						<td>
							<?php if($data->is_accept_tc == 1){ echo "Accepted";}else{echo "Not Accepted";} ?>
						</td>
						<td><?php echo $data->is_accept_tc_message; ?></td>
