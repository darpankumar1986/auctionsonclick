											...
											<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
												...
												<thead>
													<tr>
														...
														<!--<th class="head1">Select All<input type="checkbox" id="selecctall1"/></th>-->
												...
												<tbody>
													<?php $i=0;foreach($records as $data){$i++;?>
														<tr class='gradeA'>
															...
															<!--<td><input style="opacity:1 !important;" type="checkbox" class="status12" name="status[]" value="<?php echo $data->id; ?>"></td>-->
															<td><?php echo GetDateFormat($data->date_created); ?></td>
															<td><?php echo GetDateFormat($data->date_modified); ?></td>
															<td>
															<?php if($type == 'main'){?>
																<a href="/superadmin/category/addeditmain/<?php echo $data->id; ?>">Edit</a>
															<?php }else{?>
																<a href="/superadmin/category/addedit/<?php echo $data->id; ?>">Edit</a>
															<?php }?>
