...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="/superadmin/country/addedit" class="button_grey">Create Country</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Country List</div>
	</div><!--pageheader-->	
	...
	<input type="hidden" name="controller" id="controller" value="country" />
								...
								<tbody>
									...
									?>
										<tr class='gradeA'>
											...
											<td><a href="/superadmin/country/addedit/<?php echo $data->id; ?>">Edit</a></td>
										</tr>
									<?php }?>	
