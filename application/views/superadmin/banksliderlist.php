...
<div class="centercontent tables">
	<div class="pageheader notab">
		<?php
		 ...
		 if($records == 0) { ?>
		<div class="row">						
			<a href="/superadmin/news/addeditbankslider/<?php echo $bankId; ?>" class=" button_grey">Create Organization Slider Banner (<?php echo $bankName; ?>)</a>
		</div>
		<?php } ?>
		...
		<?php } ?>
		<div class="box-head">Bank Slider Banner (<?php echo $bankName; ?>)</div>
	</div><!--pageheader-->	
					...
					<tbody>
						<?php $i=0;foreach($records as $data){$i++;?>
							<tr class='gradeA'>
								...
								<td><a href="/superadmin/news/addeditbankslider/<?php echo $bankId; ?>/<?php echo $data->id; ?>">Edit</a></td>
							</tr>
						<?php }
							?>
					</tbody>
