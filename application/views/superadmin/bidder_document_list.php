...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="/superadmin/bidder_document/addedit" class="button_grey">Create Bidder Document</a>
				</div>
				...
				<?php } ?>
				<div class="box-head">Bidder Document List</div>
				<?php /* ?>
			...
			<div class="container-outer">
				<div class="container-inner">
							<table cellpadding="0" cellspacing="0" border="0" class="stdtable display">
								...
								<thead>
									<tr>
										<th class="head0">Bidder Document ID</th>
										<th class="head1">Bidder Document Name</th>
								...
								<tbody>
									...
									$totalrows=$this->bidder_document_model->GetTotalRecord($data->id);
									...
									?>
										<tr class='gradeA'>
											...
											<td>
												<a href="/superadmin/bidder_document/addedit/<?php echo $data->id; ?>">Edit</a>
