...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?>superadmin/rlogged/getLoggedList/',
						//"bJQueryUI": true,
                ...
                <div class="table-wrapper btmrg20 tpmrg20">
                           ...
                           <div style="min-height: 0px; display: block;" class="box-content no-pad table-tp-space"> 
                            <?php 
									...
									$this->table->set_heading('Logged ID', 'Organization Name','Branch Name',  'Created By', 'Create Time','Action');	
