...
<div class="centercontent tables">
	<div class="pageheader notab">
		<h1 class="pagetitle"><span style="float:left"><?php echo $heading; ?></span><span style="float:right"><a href="/superadmin/role/addedit" class="b_green"><strong>Add New</strong></a>	</span></h1>
	...
	<form action="" method="POST" id="searchfm" name="searchfm">
		...
		<br>
		<input type="hidden" name="controller" id="controller" value="role" />
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td>
							<a href="/superadmin/role/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
