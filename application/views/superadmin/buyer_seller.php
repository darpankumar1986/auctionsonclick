...
<div class="centercontent tables">
	...
	<div id="contentwrapper" class="contentwrapper">
		<input type="hidden" name="controller" id="controller" value="buyer_seller" />
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<thead>
				<tr>
					...
					<th class="head1">Stock name</th>
					<th class="head1">Action</th>
					<th class="head1">Rate</th>
					<th class="head0">Holds</th>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td>
							<a href="/superadmin/buyer_seller/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
