      ...
      <div class="dashboard-wrapper">
        ...
        <div class="container">
		  ...
		  <form name="submitEmd" id="submitEmd" action="/helpdesk_executive/SaveAuctionEmd" method="post" enctype="multipart/form-data">
			...
			<div class="heading4 btmrg20"> Uploaded File History </div>
			...
			<table width="100%" border="0px&quot;">
				<tbody>
					...
					<?php if($auctionBiddingData != 0)
					{ 
						$i=1;
						foreach ($auctionBiddingData as $bdata)
						{
					?>
					<tr class="">
						...
						<td align="left"><?php echo $bdata->indate; ?></td>
					</tr>
					<?php 
						$i++;
						}
