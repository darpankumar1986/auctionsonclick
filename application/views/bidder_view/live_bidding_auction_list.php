...
if($totalLiveAuctionData>0)
{
		...
		{	
			...
			//$this->bidder_model->autoBidIncrementAuctionBid($auctionID);
		...
		<div class="toplinks">    <a href="/buyer/view_uploadedfile/<?php echo $adata->id; ?>" class="grn-txt">View Uploaded File </a> <a href="/banker/view_bid_history/<?php echo $adata->id; ?>" class="grn-txt">Show Event Details</a></div>
