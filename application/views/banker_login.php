      ...
      <div class="login">
        <div class="left">
		  ...
		  <?php echo ($error_msg)?$error_msg:'';?>
			...
			<form method="post" action="/registration/checkbankerlogin"  id="formValidate">
				<div class="row">
				<input type="hidden" name="login_type" value="banker">
				<!-- For banker-->
				</div>
				<div class="row">
				  <input name="user_name" placeholder="Email Address*" type="text" class="input" value="<?php echo $_COOKIE['username']?>">
				</div>
				
				<div class="row">
				  <input name="user_id" placeholder="User Id*" type="text" class="input" value="<?php echo $_COOKIE['user_id']?>">
				</div>
				<div class="row">
				  <input name="password" placeholder="Password*" type="password" class="input" value="<?php echo $_COOKIE['password']?>">
				</div>
				<div class="row">
				  <input name="remember_password" type="checkbox" value="">
				  Remember me </div>
				<div class="row term"> <a href="javascript:void(0)" onclick="jQuery('#formValidate').hide();jQuery('#forgotPassword').show();">Forgot Password</a> | <a href="/registration/login" >Login With Owner User</a> </div>
				<div class="row">
			...
			<div class="forget_wrapper" style="display:none" id="forgotPassword">
				...
				<div class="row">
				  <input name="forgotemail" id="forgotemail" placeholder="Enter Email Address*" type="text" class="input">
				</div>
				 <div class="row">
				 <input name="" value="send email" onclick="submitForgotPassword('banker');" type="button" class="b_get">
				</div>
			</form>
			</div>
        ...
        <div class="right" style="border-left:solid 1px #ccc;width:299px;">
			<div class="bank_login_bg">
			  ...
			  <!--
          <div class="heading-bg"><img src="/images/register-icon.png"> Why Join C1india.com?</div>
          <div class="content">
            <div class="heading1">View Five Reasons</div>
            <ol>
              <li>Our Award-winning e-Auction engine has propelled us to the Numero Uno ranking in e-Auction space.</li>
              <li>50000+ e-Auctions completed till date. Our Auction algorithms are a result of intense market research.
			</li>
              <li> We provide training & demo-auctions to ensure you are fully adapted to the Auction Interface..</li>
              <li>20000+ listed properties. Now negotiate the price of your condominium without sweating a bit. Just stay at your home and bid!.</li>
              <li>Auctions are the way forward! We foresee the common man bidding for his dream home sitting in his sofa.</li>
            </ol>
          </div>->
        </div>
      </div>
...
jQuery("#formValidate").validate({
		...
		messages: {
			user_name: "Please enter email address.",			
			user_id: "Please enter user ID address.",			
