...
<script>
	...
	jQuery('#zone').load('/admin/bank_zone/ajax_zone/'+bank_id);
	
	}
	function getRegion(zone_id){
	jQuery('#region').load('/admin/bank_region/ajax_region/'+zone_id);
	
	}
	function getBranch(region_id){
	jQuery('#branch').load('/admin/bank_branch/ajax_branch/'+region_id);
...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="b2c" name="add_data_view" accept-charset="utf-8" action="/registration/save">
...
jQuery('#country_id').change(function(){
		...
		if(country_id )
		{
			...
			jQuery('#state_id').load('/admin/bank/getStateDropDown/'+country_id+'/'+state_id);
		}
	...
	jQuery('#state_id').change(function(){
		...
		if(state_id )
		{
			...
			jQuery('#city_id').load('/admin/bank/getCityDropDown/'+state_id+'/'+city_id);
		}
