				...
				<div class="full">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="email" onblur="checkEmailExist(this.value)" maxlength="100" id="email"  type="email" class="input alphanumericemail" value="<?php echo $email ?>">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="confirmemail" onblur="checkEmailExist(this.value)" maxlength="100" id="confirmemail" type="email" class="input alphanumericemail" value="<?php echo $email ?>">
							  <div class="tooltips">
								<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="password" maxlength="100" id="pass"  type="password" class="input" value="">
								<div class="tooltips">
								<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="cpassword" id="cpassword" maxlength="100" type="password"  value=""> 
                    ...
                    <div id="individual">
						<div class="half-2">
							<div class="row individual">
								...
								<div class="rgt_detail">
									<input name="first_name" class="alphanumeric" maxlength="75" id="first_name" type="text"  value="<?php //echo $cpassword  ?>">   
						...
						<div class="half-2">
							<div class="row individual">
								...
								<div class="rgt_detail">
									<input name="last_name"  class="alphanumeric" maxlength="75" id="last_name" type="text"  value="<?php //echo $cpassword  ?>">   
						...
						<div class="half-2">
							<div class="row individual">
								...
								<div class="rgt_detail">
									<input name="fathers_husband_name"  class="alphanumeric" maxlength="100" id="father_name" type="text"  value="<?php //echo $cpassword  ?>">   
                    ...
                    <div id="organistion" style="display: none;">
						<div class="half-2">
							<div class="row individual">
								...
								<div class="rgt_detail">
									<input name="organisation_name"  class="alphanumeric1" maxlength="50" id="organisation_name" type="text"  value="<?php //echo $cpassword  ?>">   
						...
						<div class="half-2">
							<div class="row">
								...
								<div class="rgt_detail">
									<input name="authorised_person"  class="alphanumeric" maxlength="50" id="authorised_person" type="text"  value="<?php //echo $cpassword  ?>">   
						...
						<div class="half-2">
							<div class="row">
								...
								<div class="rgt_detail">
									<input name="designation"  class="alphanumeric" maxlength="50" id="designation" type="text"  value="<?php //echo $cpassword  ?>">   
									 <div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="address1" id="address1" maxlength="200" type="text"  value="<?php //echo $cpassword  ?>">   
								<div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="address2" maxlength="100" id="address2" type="text"  value="<?php //echo $cpassword  ?>">   
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input maxlength="6" name="zipcode"  id="zipcode" class="numericonly input" type="text" value="">
								 <div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
				   ...
				   <div class="half-2">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="account_holder_name" id="account_holder_name" class="" type="text"value="">
								<div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="account_type" id="account_type" class="" type="text"value="">
								<div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="account_number" id="account_number" class="numericonly" maxlength="20" type="text"value="">
								<div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input name="ifsc_code" id="ifsc_code" class="alphaNumericTextOnly" type="text"value="">
								<div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
                   ...
                   <div class="half-2">
					   <div class="row">
							...
							<div class="rgt_detail">
								<input  maxlength="15" name="phone_number"  class="numericonly" id="phone_number"  type="text"  value="">
								<div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								...
								<input  maxlength="10" name="mobile" id="mobile_number"  class="numericonly" type="text" value="">
								  <div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						<div class="row">
							...
							<div class="rgt_detail">
								<input  maxlength="15" name="fax_number" id="fax_number" class="numericonly" type="text"value="">
								<div class="tooltips">
									<img class="tooltip_icon" src="/images/help.png">
					...
					<div class="half-2">
						 <div class="row captcha">
							...
							<div class="rgt_detail">
								...
								<input  maxlength="6" name="captcha" id="captcha" type="text" value=""> 
                    ...
                    <div class="full">
                        <p class="tnc">
							<input name="" type="checkbox" id="signupform-confirmbidder" value="" class="checkbox no-flt"> I agree that: I have read and accepted the <a href="<?php echo base_url();?>assets/front_view/images/terms_and_condition_registration.pdf" style="color:#00F; text-decoration:none;" target="_blank">User Agreement and Privacy Policy.</a><br>
