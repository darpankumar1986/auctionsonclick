...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#fff;">
	<tr class="odd">
		<td align="left" valign="top" scope="col"><h1>Your Bid Summary </h1></td>    
	</tr>
	<tr>
		<td align="left" valign="top" scope="col">&nbsp;</td>
	</tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table-bor">
      <thead>		
        <tr>
		  ...
		  <th width="25%" align="center" valign="middle" scope="col"><strong>Bidder/ Company Name </strong></th>
		  ...
		  <th width="10%" align="center" valign="middle" scope="col"><strong>Bid Date & Time </strong></th>
		  <!--
		  ...
		  <th width="35%" align="center" valign="middle" scope="col"><strong>Remarks </strong></th>-->
	  ...
	  foreach ($auctionData[0]->bidder_bid as $allBidData){
		...
		<tr class="<?php echo $clas;?>">
		 ...
		 //  echo $lastbidBidder->first_name; 
		  ...
		  <td align="center" valign="top" class=""><?php //echo ($allBidData->BidSrNo=='Rejected')?'Rejected by system':'Accepted'; ?></td>
		  <td align="left" valign="top" class=""><?php //echo ($allBidData->BidSrNo=='Rejected')?$allBidData->message:'-'; ?></td>-->
		</tr>
	<?php       
           $i++; }   ?>
