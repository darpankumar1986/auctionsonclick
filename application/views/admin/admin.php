...
<div class="centercontent tables">
	<div class="pageheader notab">
		<h1 class="pagetitle"><span style="float:left"><?php echo $heading; ?></span><span style="float:right"><a href="/admin/admin/addedit" class="b_green"><strong>Add New Admin User</strong></a>	</span></h1>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td>
							<a href="/admin/admin/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
