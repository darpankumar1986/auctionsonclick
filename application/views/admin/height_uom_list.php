...
<div class="centercontent tables">
	<div class="pageheader notab">
			<div class="row">						
					<a href="/admin/uom_type/addedit" class="button_grey">Create Plot Area UOM Type</a>
				</div>
				...
				<?php /* ?>
		<h1 class="pagetitle"><span style="float:left"><?php echo $heading; ?></span><span style="float:right"><a href="/admin/city/addedit" class="b_green"><strong>Add New City</strong></a>	</span></h1>
		<?php */ ?>
								...
								<tbody>
									...
									?>
										<tr class='gradeA'>
											...
											<td>
												<a href="/admin/height_uom_type/addedit/<?php echo $data->height_uom_id; ?>">Edit</a>
