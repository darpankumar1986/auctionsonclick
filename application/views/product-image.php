...
<div class="centercontent tables" style="margin-left:0px;">
	<div class="pageheader">
		...
		<ul class="hornav">
			<li class="current"><a href="/product_image/page_popup/<?php echo $product_id; ?>">View Images</a></li>
			<li ><a href="/product_image/add_popup/<?php echo $product_id; ?>">Add Image</a></li>
			<li class=""><a href="/product_image/add_multiple_popup/<?php echo $product_id; ?>">Add Multiple Images</a></li>
		</ul>
	</div>	
				...
				<tbody>
					...
					foreach($records as $data){$i++;?>
						<tr class='gradeA'>
							...
							<td>
								<a href="/product_image/edit_popup/<?php echo $data->id; ?>"><strong>Edit</strong></a>
...
function updatestatus(type,imgID,stval){
	 jQuery.ajax({
              url:  "<?php echo base_url();?>product_image/updateimageVideoStatus",
              type: "post",
...
function deleteImage(type,imgID,stval){
	if(confirm('Are you sure want to delete this record?')){
	 jQuery.ajax({
              url:  "<?php echo base_url();?>product_image/DeleteimageVideoStatus",
              type: "post",
              data: "type="+type+"&id="+imgID+"&stval="+stval,
              success: function(results){
				  alert(results);
