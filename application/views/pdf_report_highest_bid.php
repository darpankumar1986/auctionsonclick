...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#fff;">
	<tr class="odd">
		<td align="left" valign="top" scope="col"><h1>Highest Bid Report </h1></td>    
	</tr>
	<tr>
		<td align="left" valign="top" scope="col">&nbsp;</td>
	</tr>
...
<br><br>
  <?php if(count($auctionData[0]->bidder_bid)){
	  ...
	  $auctionNotPriceBasis = array(99);
	   ...
	   ?>
		...
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="mytable dataTable table-bor" id="big_table" aria-describedby="big_table_info">
			...
			<thead role="alert" aria-live="polite" aria-relevant="all">
				<tr class="odd">
				  <td align="center" valign="top" class=""><strong>Sr.No.</strong></td>
				 ...
				 <?php if(!in_array($auctionData[0]->id,$auctionNotPriceBasis) && false) {?><td align="left" valign="top" class=""><strong>Price Basis</strong></td><?php } ?>
				  <td align="center" valign="top" class=""><strong>Start Price</strong></td>
				  <td align="center" valign="top" class=""><strong>H1 Bidder</strong></td>
				  <td align="center" valign="top" class=""><strong>H1 Price</strong></td>
				  <td align="center" valign="top" class=""><strong>Gains in amount (h1 price - start price)</strong></td>
				  <td align="center" valign="top" class=""><strong>Gains in %</strong></td>
				  <?php if(!in_array($auctionData[0]->id,$auctionNotPriceBasis) && false) {?><td align="left" valign="top" class=""><strong>Bid Value</strong></td><?php }?>
				  <td align="center" valign="top" class=""><strong>No. of bids</strong></td>
				  <td align="center" valign="top" class=""><strong>No. of bidders</strong></td>
				</tr>
			</thead>
			<tbody role="alert" aria-live="polite" aria-relevant="all">
				<?php 
				...
				foreach($auctionData[0]->lastbidBidder as $lastbidBidder)
				{ 
						...
						$gainPrice = ($lastbidBidder->bid_value)-($auctionData[0]->opening_price);
						$gainPer = ($gainPrice/$auctionData[0]->opening_price)*100;		
				...
				<tr class="even">
				  ...
				  <td  align="center" valign="top" class=""><?php echo $auctionData[0]->PropertyDescription;  ?></td>
				  ...
				  <?php if(!in_array($auctionData[0]->id,$auctionNotPriceBasis) && false) {?><td  align="center" valign="top" class=""><?php echo 'Price per '.$unit_price; ?></td><?php } ?>
				  <td  align="center" valign="top" class=""><?php echo moneyFormatIndia($auctionData[0]->opening_price); ?></td>
				 ...
				 //  echo $lastbidBidder->first_name; 
				  ?></td>
				  <td  align="center" valign="top" class=""><?php echo moneyFormatIndia($lastbidBidder->bid_value); ?></td>
				  <td  align="center" valign="top" class=""><?php echo moneyFormatIndia($gainPrice); ?></td>
				  <td  align="center" valign="top" class=""><?php echo $gainPer; ?></td>				  
				  <?php if(!in_array($auctionData[0]->id,$auctionNotPriceBasis) && false) {?><td  align="left" valign="top" class=""><?php echo moneyFormatIndia($auction_data[0]->area*$lastbidBidder->bid_value); ?></td><?php } ?>
				  <td  align="center" valign="top" class=""><?php echo $totalbidding;?></td>
				  <td  align="center" valign="top" class=""><?php echo count($auctionData[0]->lastbidBidder); ?></td>
			  </tr>
				<?php 
					}
				}?>
