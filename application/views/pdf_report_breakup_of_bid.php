...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#fff;">
	<tr class="odd">
		<td align="left" valign="top" scope="col"><h1>Item wise break up of bid </h1></td>    
	</tr>
	<tr>
		<td align="left" valign="top" scope="col">&nbsp;</td>
	</tr>
...
<table  width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table-bor" >
	<tr class="odd">
		...
		<td width="35%" align="left" valign="top" class=""><strong>Property Details</strong></td>
		...
		<?php if(!in_array($auctionData[0]->id,$auctionNotPriceBasis) && false) {?><td width="10%" align="left" valign="top" class=""><strong>Price Basis</strong></td><?php } ?>
		<td width="10%" align="left" valign="top" class=""><strong>Category</strong></td>
		<td width="10%" align="left" valign="top" class=""><strong>Start price</strong></td>
		<td width="10%" align="left" valign="top" class=""><strong>Increment in Figure</strong></td>
	</tr>
	<?php 								
	...
	$category_name = GetTitleByField('tbl_category','id='.$auctionData[0]->category_id,'name');							          
	?>
	<tr class="even">
		...
		<td  align="left" valign="top" class=""><?php echo moneyFormatIndia($auctionData[0]->opening_price); ?></td>
		<td  align="left" valign="top" class=""><?php echo $auctionData[0]->bid_inc; ?></td>
	</tr>          
</table>					
<br>
  ...
  <tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table-bor">
      <thead>		
        <tr>
		  <th width="20%" align="left" valign="top" class=""><strong>Bidders/ Vendor company name</strong></th>
		  <th width="15%" align="left" valign="top" class=""><strong>Rate in Rs</strong></th>
		  <th width="25%" align="left" valign="top" class=""><strong>Rate in Word</strong></th>
		  <th width="5%" align="left" valign="top" class=""><strong>Rank</strong></th>
		  <?php if(!in_array($auctionData[0]->id,$auctionNotPriceBasis) && false) {?><th width="15%" align="left" valign="top" class=""><strong>Total Value</strong></th><?php } ?>
		  <th width="15%" align="left" valign="top" class=""><strong>Bid Date & Time</strong></th>
		...
		{ 
			...
			{                                    
				...
				<tr class="even">
				 ...
				 <?php if(!in_array($auctionData[0]->id,$auctionNotPriceBasis) && false) {?> <td align="left" valign="top" class=""><?php echo moneyFormatIndia($tVal);?></td><?php } ?>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table-bor">
        <thead>
         <tr>
		  ...
		  <th width="25%" align="left" valign="top" class=""><strong>Rate in Word</strong></th>
		  <th width="5%" align="left" valign="top" class=""><strong>Rank</strong></th>
		  <th width="15%" align="left" valign="top" class=""><strong>Total Value</strong></th>
		  <th width="15%" align="left" valign="top" class=""><strong>Bid Date & Time</strong></th>
		</tr>
        </thead>
        <tbody>
