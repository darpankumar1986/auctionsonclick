                            ...
                            <div class="table-wrapper btmrg20">
                                <form method="POST" action="">
                                    <!--<div class="button-row btmrg">
                                        ...
                                        <input type="button" value="Forward" onclick="location.replace('/owner/myMessage_new')" class="b_submit" />
                                    </div>-->
                                            ...
                                            <tbody><?php 
                                                ...
                                                foreach ($records as $data){?>
                                                    ...
                                                    <tr class=<?php if($i == 1){ echo "odd"; $i=2; } else if($i==2){echo "even"; $i=1;} ?>>
                                                        ...
                                                        <!--<td>
                                                            <a href="/owner/myMessage_reply_msg/<?php echo $data->id; ?>"><strong>reply</strong></a>
