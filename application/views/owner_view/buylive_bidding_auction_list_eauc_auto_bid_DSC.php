        ...
        if ($bankerAccepted == 1) {
           ...
           <div class="table-section"> 
            ...
            <?php }
				...
				<?php if (time() <= strtotime($adata->auction_end_date) && $adata->auction_bidding_activity_status != 1) { ?>
				<table border="1px" align="left" cellpadding="2" cellspacing="1" class="mytable dataTable" id="big_table" aria-describedby="big_table_info">
					<thead>
						<tr class="odd">
					...
					<tbody role="alert" aria-live="polite" aria-relevant="all">								
								<tr class="even">
                                            ...
                                            <td><input type="hidden" name="areaVal" id="areaVal" value="<?php echo $adata->area; ?>"/><?php echo $adata->area; ?></td>
                                            <td><?php echo $areaUnit;//$adata->areaUnit; ?></td>
                                            <td><?php echo 'Price per '.$pricePerUnit; //$adata->pricePerUnit ?></td>
                                            <td> <div class="half no_rgt_border" style="border:none!important;">
                                 <div class="cut_off"> 
                            ...
                            //End of numToWords function
                             ...
                             // Timer of auction 
								...
								<td><span id="riw_<?php echo $auctionID;?>"></span></td>
								<td><input type="text" name="total_bid_val_<?php echo $adata->id; ?>"  id="total_bid_val_<?php echo $adata->id; ?>" readonly /></td>
