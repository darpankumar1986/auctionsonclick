...
<?php
		...
		<div id="live_auction_section_<?php echo $auctionID;?>" class="row btmrg50">
         <div class="toplinks"> 
		  <a href="/buyer/view_uploadedfile/<?php echo $auctionID;?>"  id="view_uploadedfile_<?php echo $auctionID;?>" class="ajax_<?php echo $auctionID;?> grn-txt">View Uploaded File </a>
		  <a href="/buyer/view_bid_history/<?php echo $auctionID;?>"  id="view_bid_history_<?php echo $auctionID;?>"  class="ajax1_<?php echo $auctionID;?> grn-txt">View Bid History</a></div>
	...
	<script>
	$(".ajax_<?php echo $auctionID;?>").colorbox();
	$(".ajax1_<?php echo $auctionID;?>").colorbox();
	//$("#view_uploadedfile_<?php echo $auctionID;?>").colorbox({iframe:true, width:"50%", height:"50%"});
	//$("#view_bid_history_<?php echo $auctionID;?>").colorbox({iframe:true, width:"50%", height:"50%"});
</script>			
		<?php } } else{ ?>
