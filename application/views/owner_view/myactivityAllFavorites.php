...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bAutoWidth": false,
				"aoColumns": [{"sWidth":"10%"},{"sWidth":"25%"},{"sWidth":"25%"},{"sWidth":"20%"},{"sWidth":"20%"}],
				
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?><?php echo $controller?>/allFavoritesDatatable',
						//"bJQueryUI": true,
                ...
                <div class="tab_container3 whitebg"> 
                  ...
                  <div id="tab6" class="tab_content3">
                    ...
                    <div class="table-tp-space">
						...
						$this->table->set_heading('S/No.','Product Name','Description','Product Type','View');	
