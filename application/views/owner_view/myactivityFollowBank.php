...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?><?php echo $controller?>/followBankDatatable',
						//"bJQueryUI": true,
  ...
  <div class="row">
    <div class="wrapper-full">
      <div class="dashboard-wrapper">
              ...
              <div id="tab-pannel3" class="btmrgn">
                ...
                <div class="tab_container3 whitebg"> 
                  ...
                  <div id="tab6" class="tab_content3">
					...
					<div class="row">
                            <div class="bank-leftsection">
                                    
                                        <label>Select your bank :</label>
                                     
                                      <div>
							
							<?php foreach($followBank as $fBank){ ?>
								  <span>
								  <input checked onclick="removefollowsearchList('<?php echo $fBank;?>')" id="followBank_<?php echo $fBank?>" type="checkbox" value="">
								  <label><?php echo GetTitleById('tbl_bank',$fBank,'name')?></label>
								  </span>
							<?php } ?>
									  <!--<span>
                                        <input id="followBank" type="checkbox" value="">
                                        <label>HDFC</label>
							...
							<select onchange="savefavorite(this.value);" name="Add your favourite bank" title="Add your favourite bank"  class="select">
								<option>Add your favourite bank</option>
								<?php foreach($bank_data as $listBank){
									if(in_array($listBank->id,$followBank))continue;
									?>
								<option value="<?php echo $listBank->id?>"><?php echo $listBank->name?></option>
								<?php } ?>
							  </select>
							 </div>
                            </div>
		...
		$this->table->set_heading('S/No','Auction','Property','Organization Name','Start Date','End Date','Action' );	
