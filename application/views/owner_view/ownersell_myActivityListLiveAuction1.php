...
<script src="/js/jquery.colorbox.js"></script>
		...
		<div id="live_auction_section_<?php echo $auctionID;?>" class="row btmrg50">
          <div class="toplinks"> 
		  <a href="/owner/view_uploadedfile/<?php echo $auctionID;?>" id="view_uploadedfile_<?php echo $auctionID;?>" class="view_uploadedfile1 grn-txt">View Uploaded File </a>
		  <a href="/owner/view_bid_history/<?php echo $auctionID;?>" id="view_bid_history_<?php echo $auctionID;?>"  class="view_bid_history1 grn-txt">View Bid History</a></div>
