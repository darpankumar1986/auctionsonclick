<link rel="stylesheet" href="<?= base_url(); ?>css/bace.css">
...
<section class="container_12">
    <div class="container_12">
        <div class="container_12">
            <div class="box-head no_cursor">Bidding - Live Auction</div>
            <div style="min-height: 0px; display: block;" class="box-content no-pad">
                <div id="dt1_wrapper" class="dataTables_wrapper" role="grid">
                    <div class="fg-toolbar ui-toolbar ui-corner-tl ui-corner-tr ui-helper-clearfix">
                        <!--<div id="dt1_filter" class="dataTables_filter">*DSC enabled event is not display</div>-->
                            ...
                            <div id="live_auction_data">
                                ...
                                if ($totalLiveAuctionData != 0) {
                                    ...
                                    foreach ($auctionData as $adata) {
                                     ...
                                     <?php   //echo "lastbiddd->".$lastbidtextval;
