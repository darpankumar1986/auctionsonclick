...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bAutoWidth": false,
				"aoColumns": [{"sWidth":"10%"},{"sWidth":"15%"},{"sWidth":"19%"},{"sWidth":"15%"},{"sWidth":"12%"},{"sWidth":"12%"},{"sWidth":"15%"}],
				
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?><?php echo $controller?>/sellCompleteAuctionDatatable',
						//"bJQueryUI": true,
