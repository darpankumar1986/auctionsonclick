...
<script type="text/javascript">
        /*$(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bAutoWidth": false,
				"aoColumns": [{"sWidth":"10%"},{"sWidth":"30%"},{"sWidth":"30%"},{"sWidth":"30%"}],
				
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?><?php echo $controller?>/lastSearchDatatable',
						//"bJQueryUI": true,
...
<!-- js and css for new form which shows grid of last search-->
...
<!-- end js and css for new form which shows grid of last search-->
          ...
          <li class="detail-full" >
              ...
              <div class="left-section">
                   ...
                   <div class="property-detail">
                    <div class="block reserve"><span>Reserve Price:</span> <?php echo $reserve_price; ?></div>
