...
<section class="container_12">						
    <div class="container_12"  id="live_auction_data">	
       ...
       <?php
        ...
        $totalLiveAuctionData = count($auctionData);
        ...
        <div class="nit_time_remaining">Time Remaining:  <?php if ($adata->auction_bidding_activity_status == 1) { ?>
                                                        ...
                                                        <?php } ?>
                                                            <span class="success_msg"><?php  echo $this->session->userdata('response_msg_'.$auctionID); 
                                                                                           //  $this->session->unset_userdata('response_msg_'.$auctionID);?></span>
        </div>
    ...
    <?php if (($autobidExist <= 0) || ($getAutocutRow->auto_bid <= $h1price)) { ?>
            <div class="half no_rgt_border" style="background:#fff; border:none!important;">
                Bid Amount
                <div class="cut_off"> 
                    <input type="text"  onchange="showText();"  onkeypress="return isNumberKey(event);" value="<?php echo $bidtextval; ?>"  name="bidder_bid_value_<?php echo $adata->id; ?>" id="bidder_bid_value_<?php echo $adata->id; ?>" class="input-sort">
            ...
            <?php
                ...
                <div class="row" style="font_size:12px;">
                    <div  id="is_accept_tc_upid_<?php echo $auctionID; ?>">
                        ...
                        <span>I agree that : I have read and accepted the <a href="#" target="_blank"   class="terms grn-txt">User Agreement and Privacy Policy.</a> I may receive communications from <?php echo BRAND_NAME; ?>. </span>
                    </div>
                </div>
            <?php } ?>
        <?php
