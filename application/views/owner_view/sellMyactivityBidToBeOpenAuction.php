...
<script type="text/javascript">
        $(document).ready(function() {
			var oTable = $('#big_table').dataTable( {
				...
				"bAutoWidth": false,
				"aoColumns": [{"sWidth":"10%"},{"sWidth":"20%"},{"sWidth":"20%"},{"sWidth":"20%"},{"sWidth":"20%"},{"sWidth":"10%"}],
				
				"bServerSide": true,
				"sAjaxSource": '<?php echo base_url(); ?><?php echo $controller?>/auctionBidToBeOpenAuction',
						//"bJQueryUI": true,
          ...
          <div class="tab_container6"> 
            ...
            <div id="tab1" class="tab_content6" style="display:block">
              <div id="tab-pannel3" class="btmrgn">
                  ...
                  <a href="/owner/sellMyActivity"><li class="active" rel="tab10">My Activity</li></a>
                  ...
                  <div id="tab6" class="tab_content3">
                    ...
                    <div class="table-heading btmrg">
                     ...
                     <div class="table-tp-space"> 
						...
						$this->table->set_heading('Auction No ','Auction Title', 'Property Address', 'Start Date', 'End Date','Action' );	
