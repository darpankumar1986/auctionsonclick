...
.datagrid table tbody td {font-size:9px; word-wrap:break-word; cursor:pointer;     word-break: break-all; padding: 10px 5px !important;}
...
@media only screen and (max-width: 768px)  {
	...
	.mytable tfoot{display:none;}
	 .mytable .sorting_1{display:none;}
</style>
<script>
jQuery(document).ready(function ($) {
$(".check_dsc").colorbox({inline:true, width:"50%"});

$(".upload_doc_iframe").colorbox({iframe: true, width: "100%", height: "50%", onClosed: function () {
location.reload(true);
}});
$(".iframe").colorbox({iframe: true, width: "70%", height: "100%", onClosed: function () {
location.reload(true);
}});
$(".iframe_paytenderfee").colorbox({iframe: true, width: "100%", height: "70%", onClosed: function () {
location.reload(true);
}});
$(".inline_auctiondetail").colorbox({inline: true, width: "100%", onClosed: function () {
location.reload(true);
}});

$(".emd_detail_iframe").colorbox({inline: true, width: "100%", onClosed: function () {
location.reload(true);
}});
...
<table id="big_table" width="100%" border="1" cellpadding="2" cellspacing="1" class="display mytable mytable1 dataTable" aria-describedby="big_table_info">
...
<td width="30%" align="left" valign="top" class="participate_heading">Bank Processing Fee</td>
<?php
...
<a style="display:none" class='iframe_paytenderfee green_link' href="/owner/paytenderfee/<?php echo $bidderid; ?>/<?php echo $auction_id; ?>">Pay/Update</a>
<?php  if ($tender_paid != 'success') { ?>
<a class='green_link' href="/owner/payAmt/<?php echo $bidderid; ?>/<?php echo $auction_id; ?>/tender">Pay/Update</a>
<?php } ?>
</td>
<td width="30%" align="left" valign="top" class="bold_txt"><?php
if ($tender_paid == 'success') {
...
<tr class="even">
	...
	<td align="left" valign="top" class="">
		...
		if ($emd_paid != 'success' && $jda_payment_status != 'success') {
			 ?>
		<a class='green_link' href="<?php echo base_url(); ?>owner/payAmt/<?php echo $bidderid; ?>/<?php echo $auction_id; ?>/emd"><input type="button" class="b_submit float-right button_grey" name="" value="Pay Now" /></a><!--target="_blank"-->
		<?php }
		else
		{
			echo '--';
	...
	<td align="left" valign="top" class="bold_txt"> <span style="font-weight:normal">Payment Status:</span>
       <?php 
...
<tr class="odd">
	...
	<td align="left" valign="top" class="participate_heading">Documents</td>
			...
			<td align="left" valign="top" class=""><a class='upload_doc_iframe green_link button_grey' href="/owner/submitDocument/<?php echo $bidderid; ?>/<?php echo $auction_id; ?>">Upload Doc</a></td>
	<td align="left" valign="top" class="bold_txt">	<span style="font-weight:normal">Document Status:</span>
		<?php
			if ($documents_paid) {
				echo "Uploaded";
			} else {
...
<?php /*if($auction_data->dsc_enabled=='1'){ 
$cert_serial_no=GetTitleByField("tbl_auction_participate", "bidderID='".$bidderid."' and auctionID='".$auction_id."'", "cert_serial_no");
*/ ?>
<?php 
/*
if(!$cert_serial_no && false){ ?>
<a href="#form_bg" class="check_dsc button_grey">Check DSC</a>
...
<?php  }else{ ?>
<input name="fSave" value="Final Submit" onclick="return validateParticipate('final_save');" type="submit" class="b_submit float-right button_grey" <?php if($jda_payment_status =='pending'){ echo 'disabled="disabled"'; } ?> >
<?php  }
*/ ?>
<?php /*   }else{ */
...
table.dataTable td{  padding: 15px 5px !important;}
