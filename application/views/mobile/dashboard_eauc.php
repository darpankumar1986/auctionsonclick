...
<style>
    ...
    .rjct .heading4 {background: url(../images/grad-overlay-s.png) #393939;border-radius: 2px;padding: 5px 1%;color: #ddd;font-size: 14px;font-weight: 600;text-align: left;text-shadow: 0 1px 0 #222;width: 98%;float: left;}
...
<script type="text/javascript">
        $(document).ready(function() 
        {
			...
			var oTable = $('#live_event_table').dataTable({
						...
						"fnRowCallback": function (nRow, aData, iDisplayIndex) {
							...
							*/
							...
							var actionData = '<a class="" href="<?php echo base_url(); ?>owner/auctionParticipage/'+aData[1]+'"><img src="/bankeauc/images/track.png" title="Track Auction" class="edit1"></a> <a class="" href="<?php echo base_url(); ?>owner/pro_detail/'+aData[9]+'" ><img src="/bankeauc/images/view.png" title="View Auction" class="edit1"></a> '+imgTag;
							//<a href="javascript:void(0);" onclick="addtoeventfavlist('+aData[1]+')"><img src="../images/addtoFav.jpg"  width="20" height="20" title="Add to favourite" class="imgfav"></a>
			...
			// START :: LIVE AND UPCOMING AUCTION STAGE
				...
				$("#upcomming_auction_main thead tr th").eq(2).addClass("hidetd");				
				$("#upcomming_auction_main thead tr th").eq(5).addClass("hidetd");
				$("#upcomming_auction_main thead tr th").eq(6).addClass("hidetd");
				$("#upcomming_auction_main thead tr th").eq(7).addClass("hidetd");
				$("#upcomming_auction_main thead tr th").eq(8).addClass("hidetd");
        ...
        // START ::  AUCTION INProgress
				...
				$("#auction_inprogress thead tr th").eq(2).addClass("hidetd");
				$("#auction_inprogress thead tr th").eq(5).addClass("hidetd");
				$("#auction_inprogress thead tr th").eq(6).addClass("hidetd");
				$("#auction_inprogress thead tr th").eq(8).addClass("hidetd");
...
<section class="container_12">
		...
		<div style="min-height: 0px; display: block;" class="box-content no-pad">
			...
			$this->table->set_heading('','Auction No ','Department Name','Property Desc.','Property ID','Remaining Time', 'Auction Start Date', 'Auction End Date','Status', 'Action' );	
			echo $this->table->generate(); 
		   ?>
		...
		<div style="min-height: 0px; display: block;" class="box-content no-pad">			
			...
			$this->table->set_heading('','Auction No ','Department Name', 'Property Desc.', 'Property ID', 'Auction Start Date', 'Auction End Date', 'Action' );	
			echo $this->table->generate(); 
		  ?>				
		</div>
		<?php /* ?>	
		...
		<div style="min-height: 0px; display: block;" class="box-content no-pad">			
			<?php 
				...
				$this->table->set_heading('','Auction No ','Department Name', 'Property Desc.','Property ID','Apply And EMD Start Date', 'Apply And EMD End Date', 'Reserve Price','EMD','', 'Action' );	
				echo $this->table->generate(); 
			?>
		</div>
		<?php /*
