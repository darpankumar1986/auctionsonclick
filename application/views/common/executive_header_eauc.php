...
.box-head1 .home_links li{font-size:12px; padding: 5px 1px; font-weight:200;}
}
</style>
<?php
			$date = new DateTime();
...
<header><!--============================header==================================-->
		...
		<div class="box-head1 no_border">
			<div class="container_12">
				...
				<span class="flt_rgt">
					<ul class="home_links">
                                                <a href="<?=  base_url();?>sales_coordinator/event_logging_list"><li>Event Logging List&nbsp;&nbsp; |</li></a>
						<a href="<?=  base_url();?>sales_coordinator"><li>Event Logging&nbsp;&nbsp; |</li></a>
						<a href="<?=  base_url();?>sales_coordinator/createBranch"><li>Create Branch</li></a>
					</ul>
					</span>
			</div>
	   </div>
