<footer>
  <div class="wrapper">
    ...
    <ul>
      <div>Help </div>
      <li><a target="_blank"  href="/news-listing">In the News</a></li>
      <li><a target="_blank"  href="/blog">Blog</a></li>
	    <li>
		<p>
	    LiveChat <br>
		CallUs at:<br> +91-120-4888888<br>
		Mon-Fri  9AM-6PM</p>
	  </li>
    </ul>
    <ul>
  ...
  <div class="copyright">
    <div class="wrapper">
      <div class="float-left">Copyright 2008-2015. All Rights Reserved. | <a target="_blank"  href="/page/about-us">About Us</a> | <a target="_blank"  href="/page/terms-conditions">Terms of use</a> | <a target="_blank"  href="/page/privacy-policy">Privacy Policy</a></div>
      <div class="footer-social"> <span>Follow us on</span> <a target="_blank"  href=" http://facebook.com"><img src="/images/icon_fb.png" title="facebook icon" alt="facebook icon" /></a> <a target="_blank"  href=" http://twitter.com"><img src="/images/icon_twitter.png" title="twitter icon" alt="twitter icon" /></a> <a target="_blank"  href=" http://linkedin.com"><img src="/images/icon_in.png" title="linkedin icon" alt="linkedin icon" /></a> <a target="_blank"  href="javascript:"><img src="/images/icon_blog.png" title="blog icon" alt="blog icon" /></a> </div>
    </div>
  </div>
</footer>
</body>
