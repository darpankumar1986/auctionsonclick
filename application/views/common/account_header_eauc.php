...
function logoutuser(e) { 
    if (!e) e = window.event;
     $.ajax({url: "<?php //=  base_url();?>/registration/logout",  success: function(result){}});
	  ...
	  ?>
						<div class="box-head1 no_border">
								<div class="container_12">
									...
									<span class="flt_rgt">
												<a href="<?=  base_url();?>account" style="color:#fff;font-size:12px;">Dashboard</a>
												...
												<option value="<?=  base_url();?>account/paymentDue">Payment Due</option>
												<option value="<?=  base_url();?>account/completedEventPaymentDue">Outstanding payment</option>
												<option value="<?=  base_url();?>account/addInvoiceDetail">Add Invoice Detail</option>
												<option value="<?=  base_url();?>account/invoiceXls">Invoice Excel Sheet For Tally</option>
												<option value="<?=  base_url();?>account/duplicateInvoice">Duplicate Invoice</option>
												<option value="<?=  base_url();?>account/search">Search</option>
												<!--<option value="<?=  base_url();?>account/paymentFollowUpList">Payment FollowUp List</option>-->
												<!--<option value="<?=  base_url();?>account/frowardToSalesExecutiveList">Forward To Sales Executive List</option>-->
												<option value="<?=  base_url();?>account/invoiceReport">Invoice Report</option>
												<option value="<?=  base_url();?>account/creditNoteList">Credit Note List</option>
												<option value="<?=  base_url();?>account/completeMISReport">Complete MIS Report</option>
												<!--<option value="<?=  base_url();?>account/completeMonthEndReport">Complete Month End Report</option>-->
												<!--<option value="<?=  base_url();?>account/updatePayment">Update Payment</option>-->
