						...
						<table border="1" align="left" cellpadding="2" cellspacing="1" class="mytable dataTable" id="big_table5" aria-describedby="big_table_info">
							...
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								...
								if(count($transferData)){
									foreach($transferData as $key => $tData)
									{
								?>
									<tr class="even">														
										<td><?php echo ++$key?></td>
										<td align="left" valign="top" class=""><?php echo $tData->dispose_order_no; ?></td>
										
                                                                                <td>
                                                                                    <a href="<?php echo base_url()?>pdfdata/initiate_transfer_pdf/<?php echo $auction_id;?>/<?php echo $tData->dispose_order_no; ?>/S" download><img src="<?php echo base_url('images/pdf-icon.jpg'); ?>" class="table_icon"></a>
                                                                                </td>
										<td>
                                                                                    <a href="<?php echo base_url()?>pdfdata/initiate_transfer_pdf/<?php echo $auction_id;?>/<?php echo $tData->dispose_order_no; ?>/C" download><img src="<?php echo base_url('images/pdf-icon.jpg'); ?>" class="table_icon"></a>
                                                                                </td>	
