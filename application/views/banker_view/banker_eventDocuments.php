			...
			*/
			...
			?>
				...
				<div class="col-xs-6 col-sm-3 col-md-3 text-center" style="float:left;">
                    ...
                    <a class="bidderwiseitem cboxElement thumbnail" href="<?php echo base_url();?>buyer/quick_view/public/uploads/event_auction/<?php echo $img['file_path']; ?>" class="" data-toggle="modal" data-target="#lightbox">
...
<script>
$(".bidderwiseitem").colorbox({iframe:true, width:"60%", height:"430px"});
</script>
