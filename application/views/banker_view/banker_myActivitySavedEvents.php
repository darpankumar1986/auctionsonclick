                ...
                <div class="secttion-right">
                  <div class="table-wrapper btmrg20">
                    ...
                    <div style="min-height: 0px; display: block;" class="box-content no-pad table-tp-space"> 
						...
						$this->table->set_heading('Auction ID','Property ID', 'Department Name', 'Property Address', 'Property description', 'Reserve Price', 'Status','Comments','Action');	
