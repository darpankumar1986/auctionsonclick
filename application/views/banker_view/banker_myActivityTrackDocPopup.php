          ...
          <table border="1" align="left" cellpadding="2" cellspacing="1" class="mytable dataTable" id="big_table" aria-describedby="big_table_info">
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                ...
                <?php $i=0;foreach($doc as $doc_detail ){
					$imgArr = explode('.',$doc_detail->document_name);
					?>
                <tr class="even">
                  ...
                  <td align="left" valign="top" class="">
					  ...
					  {
					  ?>
					  <a download class="" href="<?php echo base_url(); ?>public/uploads/document/<?php echo $auctionID?>/<?php echo $bidderID?>/<?php echo $doc_detail->document_name?>" class="">
					  ...
					  {
					  ?>
					 <img src="<?php echo base_url(); ?>public/uploads/document/<?php echo $auctionID?>/<?php echo $bidderID?>/<?php echo $doc_detail->document_name?>" >
					  <?php } ?>  
