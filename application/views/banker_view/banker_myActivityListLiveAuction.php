...
jQuery(document).ready(function($){		
 $(".view_uploadedfile1").colorbox({iframe:true, innerWidth:800, innerHeight:400});
 $(".view_bid_history1").colorbox({iframe:true, innerWidth:800, innerHeight:400});
});
</script>
                ...
                <div class="secttion-right">
                  <div class="table-wrapper btmrg20">
                    <div class="table-heading btmrg">
						<div class="box-head custom123 no_cursor">Live Auction</div>
                    </div>
					...
					if($totalLiveAuctionData!=0)
					{
						...
						{	
							...
							if($CountAuctionFinalSubmitData>0) //Bid Count
							{
						?>						
						<div id="live_auction_section_<?php echo $auctionID;?>" class=" btmrg50">
							<div class="toplinks"></div>
							<div class="refrence-number nit_number font_18">
								Property ID: <span class="grn-txt2"><?php echo $adata->reference_no?></span> 
							</div>							
							<div class="tablehead-bg">
								...
								{?>
									<div class="nit_time_remaining white_bg">
										<div class="heading"><span class="icon_time-remaining"></span>
											<span style="background-color:#f00;padding:5px;color:#fff;font-size:18px;font-weight:normal;">Time Remaining -</span>
								...
								<?php } ?>
								<div class="view_half1 white_bg">
									<!--<a onclick="return bidderHoleinfoPopup('bidder_detail','<?php echo $auctionID;?>');" href="javascript:" id="view_bid_history_<?php echo $auctionID;?>"  class="view_bid_history1 grn-txt">View Bid History</a>-->
									<a href="/buyer/view_bid_history/<?php echo $auctionID;?>" id="view_bid_history_<?php echo $auctionID;?>"  class="view_bid_history1 grn-txt">View Bid History</a>
								</div>
								<div class="view_half1  txt_rgt">
									<!--<a onclick="return bidderHoleinfoPopup('uploaded_file','<?php echo $auctionID;?>');" href="javascript:" id="view_uploadedfile_<?php echo $auctionID;?>" class="view_uploadedfile1 grn-txt">View Uploaded File </a>-->
...
<script>
	//live_bidding_auction_list
$(document).ready(function(){
     jQuery.ajaxSetup({ cache: false });
	setInterval(function(){
	var rand = Math.random() * 100000000000;
	$("#live_auction_data").load('/buyer/liveBiddingAuctionsdatatable/<?php echo $auctionId;?>?rand='+rand);
	var days =0;
	$('[data-countdown]').each(function() {
		var $this = $(this), finalDate = $(this).data('countdown');
		$this.countdown(finalDate, function(event) {
