                ...
                <div class="secttion-right">
                  <div class="table-wrapper btmrg20">
                    <div class="table-heading btmrg">
                      <div class="box-head">Rejected Bids Report</div>
                    </div>
						...
						<table border="1" align="left" cellpadding="2" cellspacing="1" class="mytable dataTable" id="big_table" aria-describedby="big_table_info">
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								<tr class="odd">
								  ...
								  <td width="20%" align="center" valign="top" class=""><strong>Remarks </strong></td>
							...
							$rank="H1";
								...
								<tr class="even">
								 ...
								 //  echo $lastbidBidder->first_name; 
								  ...
								  <td align="left" valign="top" class=""><?php echo $bid_detail->message; ?></td>						
								</tr>
								<?php $i++; } ?>
							</tbody>             
						 </table>
						 ...
						 <table border="1" align="left" cellpadding="2" cellspacing="1" class="mytable dataTable" id="big_table" aria-describedby="big_table_info">
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								<tr class="odd">
								  ...
								  <a target="_blank" href="/pdfdata/genete_pdf_rejected_bid_report/<?php echo $auctionID;?>"><input class="b_submit float-left button_grey" type="button" value="Export To PDF" />
								  </td>								  
								</tr>
							</tbody>             
						 </table>
