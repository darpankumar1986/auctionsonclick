    ...
    <table  width="100%" border="0" align="left" cellpadding="5px" cellspacing="0" style="margin-top: 40px;">
        <tbody role="alert" aria-live="polite" aria-relevant="all">
            <tr class="">
                ...
                <td width="30%" align="left" valign="top" class=""><strong><?php echo date('d-m-Y',strtotime($cTransferData->cheque_date)); ?><strong></td>
            </tr>								
            <tr class="">
                <td width="10%" align="left" valign="top" class="">&nbsp;</td>
            ...
            <tr class="">
                ...
                <td width="20%" align="left" valign="top" class="" style="padding-left: 5%;">
                    <?php 
                        $dpart = explode('.', number_format($cTransferData->total_amt, 2))[1];
                        if($dpart > 0)
                        {
                    ...
                    ?>
                    <strong>
                        <?php echo "RUPEES ". strtoupper(getAmountInWords($cTransferData->total_amt)).$paise.' ONLY'; ?>
                    </strong>
                </td>
            ...
            <tr class="">
                ...
                <td width="30%" align="left" valign="top" class=""><strong>##<?php echo $cTransferData->total_amt; ?>##</strong></td>
            </tr>
        </tbody>
    </table>
